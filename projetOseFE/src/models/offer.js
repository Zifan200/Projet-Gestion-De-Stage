...
export const getOfferSchema = () =>
  z
    .object({
      title: z.string().min(1, i18n.t("employer_dashboard_add_intership:validation.title_required")),
      description: z
        .string()
        .min(1, i18n.t("employer_dashboard_add_intership:validation.description_required")),
      targetedProgramme: z
        .string()
      ...
      expirationDate: z
        .string()
        .min(1, i18n.t("employer_dashboard_add_intership:validation.expiration_required")),
      startDate: z.string().min(1, i18n.t("employer_dashboard_add_intership:validation.start_required")),
      endDate: z.string().min(1, i18n.t("employer_dashboard_add_intership:validation.end_required")),
    })
    // Vérifie que endDate >= startDate
    .refine((data) => new Date(data.endDate) >= new Date(data.startDate), {
      message: i18n.t("employer_dashboard_add_intership:validation.end_after_start"),
      path: ["endDate"],
    })
    ...
    .refine(
      ...
      {
        message: i18n.t("employer_dashboard_add_intership:validation.expiration_before_start"),
        path: ["expirationDate"],
      },
    )
    ...
    .refine(
      ...
      {
        message: i18n.t("employer_dashboard_add_intership:validation.expiration_not_past"),
        path: ["expirationDate"],
      },
    );
