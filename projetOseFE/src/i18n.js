    ...
    translation: {
      ...
      offer: {
        ...
        form: {
          ...
          placeholders: {
            title: "Please enter the title of your internship offer",
            description: "Please enter the full description of the offered internship",
            program: "Please select the targeted program",
    ...
    translation: {
      ...
      offer: {
        ...
        form: {
          ...
          placeholders: {
            title: "Veuillez saisir le titre de votre offre de stage",
            description: "Veuillez saisir la description complète du stage proposé",
            program: "Veuillez sélectionner le programme visé",
