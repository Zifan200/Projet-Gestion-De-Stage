...
public class InternshipApplicationControllerException {
    ...
    public ResponseEntity<ErrorResponseDTO> handleInvalidInternShipApplication(InvalidInternshipApplicationException ex) {
        return buildError(HttpStatus.BAD_REQUEST, "Invalid Internship application", ex.getMessage());
    }

    @ExceptionHandler(InvalidApprovalStatus.class)
    public ResponseEntity<ErrorResponseDTO> handleInvalidInternShipApplicationStatus(InvalidApprovalStatus ex) {
        return buildError(HttpStatus.BAD_REQUEST, "Invalid Internship application status", ex.getMessage());
    }
